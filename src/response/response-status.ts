...
export const ResponseStatus = {
    ...
    FILE_F001: createResponseStatus("FILE_F001", "File delete fail"),
    ...
    CHAT_ROOM_F008: createResponseStatus("CHAT_ROOM_F008", "No permission to delegate admin permission"),
    CHAT_ROOM_F009: createResponseStatus("CHAT_ROOM_F009", "No Member in Chat Room"),
    CHAT_ROOM_F010: createResponseStatus("CHAT_ROOM_F010", "No permission to update chatroom info"),
    ...
    CHAT_ROOM_S009: createResponseStatus("CHAT_ROOM_S009", "POST /chat-rooms/:id/files"),
